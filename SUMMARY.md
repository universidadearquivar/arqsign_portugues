...
* [💻 Visão Geral da Plataforma 2.3.1](README.md)
...
* [📁 Documentos](diretorios/documentos/README.md)
  * [🟪 Configuração de diretórios para clientes que ainda não assinaram documentos](diretorios/documentos/configuracao-de-diretorios-para-clientes-que-ainda-nao-assinaram-documentos.md)
  * [🟪 Configuração de diretórios para clientes que já assinaram documentos](diretorios/documentos/configuracao-de-diretorios-para-clientes-que-ja-assinaram-documentos.md)
...
* [🧩 Integrações](administracao/integracoes/README.md)
  * [🟪 API](administracao/integracoes/api/README.md)
    * [🔳 Requisitos para uso da API](administracao/integracoes/api/requisitos-para-uso-da-api.md)
    * [🔳 Limites de Requisições da API](administracao/integracoes/api/limites-de-requisicoes-da-api.md)
    * [🔳 Métodos disponíveis na API](administracao/integracoes/api/metodos-disponiveis-na-api/README.md)
      * [📂 1. Processo](administracao/integracoes/api/metodos-disponiveis-na-api/1.-processo/README.md)
        ...
        * [✔️ 1.1.GET/api/v2/processo/{idProcesso}](administracao/integracoes/api/metodos-disponiveis-na-api/get-api-v2-processo-idprocesso.md)
        ...
        * [✔️ 1.6.PATCH/api/v1/processo/{idProcesso}/cancelar-processo](administracao/integracoes/api/metodos-disponiveis-na-api/1.-processo/1.6.patch-api-v1-processo-idprocesso-cancelar-processo.md)
        * [✔️ 1.7.POST/api/v1/processo/{idProcesso}/buscar-anexos-signatarios](administracao/integracoes/api/metodos-disponiveis-na-api/1.-processo/1.7.post-api-v1-processo-idprocesso-buscar-anexos-signatarios.md)
        * [✔️ 1.8.GET/api/v1/processo/{idArquivoProcesso}/registro-assinaturas](administracao/integracoes/api/metodos-disponiveis-na-api/1.-processo/1.8.get-api-v1-processo-idarquivoprocesso-registro-assinaturas.md)
      * [📂 2. Diretórios](administracao/integracoes/api/metodos-disponiveis-na-api/2.-diretorios/README.md)
        * [✔️ 2.1.POST/api/v1/diretorio/buscar-pastas](administracao/integracoes/api/metodos-disponiveis-na-api/2.-diretorios/2.1.post-api-v1-diretorio-buscar-pastas.md)
      * [📂 3. Usuários](administracao/integracoes/api/metodos-disponiveis-na-api/3.-usuarios/README.md)
        * [✔️ 3.1.POST/api/v1/usuarios/buscar-usuarios](administracao/integracoes/api/metodos-disponiveis-na-api/3.-usuarios/3.1.post-api-v1-usuarios-buscar-usuarios.md)
      * [📂 4. Conta](administracao/integracoes/api/metodos-disponiveis-na-api/4.-conta/README.md)
        * [✔️ 4.1.GET/api/v1/conta/papeis-signatarios](administracao/integracoes/api/metodos-disponiveis-na-api/get-api-v1-conta-papeis-signatarios.md)
        * [✔️ 4.2.POST/api/v1/conta/buscar-consumo-itens-assinatura](administracao/integracoes/api/metodos-disponiveis-na-api/post-api-v1-conta-buscar-consumo-itens-assinatura.md)
        * [✔️ 4.3.GET/api/v1/conta/dados-assinatura](administracao/integracoes/api/metodos-disponiveis-na-api/get-api-v1-conta-dados-assinatura.md)
      * [📂 5. Webhook](administracao/integracoes/api/metodos-disponiveis-na-api/5.-webhook/README.md)
