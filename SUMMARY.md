...
* [🧩 Integrações](administracao/integracoes/README.md)
  * [🟪 API](administracao/integracoes/api/README.md)
    ...
    * [🔳 Métodos disponíveis na API](administracao/integracoes/api/metodos-disponiveis-na-api/README.md)
      * [✔️ POST/api/v2/processo/enviar-documento-para-assinar](administracao/integracoes/api/metodos-disponiveis-na-api/post-api-v2-processo-enviar-documento-para-assinar.md)
      * [✔️ GET/api/v2/processo/{idProcesso}](administracao/integracoes/api/metodos-disponiveis-na-api/get-api-v2-processo-idprocesso.md)
      * [✔️ PATCH/api/v2/processo/{idProcesso}/reenviar-processo](administracao/integracoes/api/metodos-disponiveis-na-api/patch-api-v2-processo-idprocesso-reenviar-processo.md)
      * [✔️ POST/api/v1/processo/enviar-documento-para-assinar](administracao/integracoes/api/metodos-disponiveis-na-api/post-api-v1-processo-enviar-documento-para-assinar.md)
      * [✔️ GET/api/v1/processo/{idprocesso}](administracao/integracoes/api/metodos-disponiveis-na-api/get-api-v1-processo-idprocesso.md)
      ...
      * [✔️ PATCH/api/v1/processo/{idProcesso}/reenviar-processo](administracao/integracoes/api/metodos-disponiveis-na-api/patch-api-v1-processo-idprocesso-reenviar-processo.md)
